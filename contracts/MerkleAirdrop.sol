...
contract MerkleDistributor is ERC1155Holder {
    ...
    function getAddressAirdrop(uint256 _airdropID) public view returns (AddressAirdrop memory) {
        return addressAirdrops[_airdropID];
    }

    function getGotchiAirdrop(uint256 _airdropID) public view returns (GotchiAirdrop memory) {
